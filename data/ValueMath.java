 ...
 * from other Value objects. For example, "new ValueMath(a,b,'+')" is an object
 * whose value is obtained by adding the values of a and b.
 */
...
public class ValueMath implements Value {
	...
	public double getVal() {
		if (f != null) {
			...
			default:
				throw new IllegalArgumentException(
						"Internal Error:  Unknown math operator.");
			}
		}
	}
